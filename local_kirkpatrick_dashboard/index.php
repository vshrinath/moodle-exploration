...
/**
 * Render a Kirkpatrick metric card using shared card system.
 *
 * @param string $title
 * @param string $value
 * @param string $status
 ...
 * @return string
 */
function local_kirkpatrick_dashboard_render_metric(string $title, string $value, string $status = 'info', string $details = ''): string {
    if (class_exists('\local_sceh_rules\output\sceh_card')) {
        return sceh_card::metric([
            'size' => 'small',
            'status' => $status,
            'title' => $title,
            'value' => $value,
    ...
    return html_writer::div(
        ...
        html_writer::tag('div', $value, ['class' => 'metric-value']),
        'metric-card'
    );
}
...
echo html_writer::start_div('level-metrics sceh-rules-grid');
...
echo local_kirkpatrick_dashboard_render_metric(
    get_string('avgsatisfaction', 'local_kirkpatrick_dashboard'),
    number_format($avg_satisfaction, 1) . '/10',
    'success'
);
...
echo local_kirkpatrick_dashboard_render_metric(
    get_string('avgengagement', 'local_kirkpatrick_dashboard'),
    number_format($avg_engagement, 1) . '/10',
    'success'
);
...
echo local_kirkpatrick_dashboard_render_metric(
    get_string('totalresponses', 'local_kirkpatrick_dashboard'),
...
echo local_kirkpatrick_dashboard_render_metric(
    get_string('lowsatisfaction', 'local_kirkpatrick_dashboard'),
    (string)$low_satisfaction,
    'warning'
);
...
echo local_kirkpatrick_dashboard_render_metric(
    get_string('avgknowledgegain', 'local_kirkpatrick_dashboard'),
    number_format($avg_knowledge_gain, 1) . '%',
    'success'
);
...
echo local_kirkpatrick_dashboard_render_metric(
    get_string('competenciesachieved', 'local_kirkpatrick_dashboard'),
    (string)$competencies_achieved,
    'success'
);
...
echo local_kirkpatrick_dashboard_render_metric(
    get_string('badgesearned', 'local_kirkpatrick_dashboard'),
    (string)$badges_earned,
    'info'
);
...
echo local_kirkpatrick_dashboard_render_metric(
    get_string('atrisklearners', 'local_kirkpatrick_dashboard'),
    (string)$at_risk,
    'warning'
);
...
echo local_kirkpatrick_dashboard_render_metric(
    get_string('avgperformance', 'local_kirkpatrick_dashboard'),
    number_format($avg_performance, 1) . '/10',
    'success'
);
...
echo local_kirkpatrick_dashboard_render_metric(
    get_string('behaviortracked', 'local_kirkpatrick_dashboard'),
    (string)$behavior_tracked,
    'info'
);
...
echo local_kirkpatrick_dashboard_render_metric(
    get_string('evidencesubmitted', 'local_kirkpatrick_dashboard'),
    (string)$evidence_submitted,
    'info'
);
...
echo local_kirkpatrick_dashboard_render_metric(
    get_string('followupcompletion', 'local_kirkpatrick_dashboard'),
...
if ($level4_installed) {
    ...
    echo local_kirkpatrick_dashboard_render_metric(
        get_string('totalcostsavings', 'local_kirkpatrick_dashboard'),
    ...
    echo local_kirkpatrick_dashboard_render_metric(
        get_string('avgroi', 'local_kirkpatrick_dashboard'),
        number_format($avg_roi, 1) . '%',
        'success'
    );
    ...
    echo local_kirkpatrick_dashboard_render_metric(
        get_string('avgproductivity', 'local_kirkpatrick_dashboard'),
        number_format($avg_productivity, 1) . '%',
        'success'
    );
    ...
    echo local_kirkpatrick_dashboard_render_metric(
        get_string('programsmeasured', 'local_kirkpatrick_dashboard'),
        (string)$programs_measured,
        'info'
    );
